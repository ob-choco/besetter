...
class CreateRouteRequest(BaseModel):
    ...
    title: Optional[str] = Field(None, description="루트 제목", min_length=1, max_length=50)
    description: Optional[str] = Field(None, description="루트 설명", max_length=500)
    ...
    grade_score: Optional[int] = Field(None, description="등급 점수", ge=0, le=10000)
